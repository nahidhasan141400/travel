  ...
  return (
    <div className="w-full h-screen flex justify-center flex-col items-center bg-img1">
      <div className="w-full text-center flex flex-col justify-center items-center  relative h-full flex-2">
        ...
        <h1 className="text-4xl">MOST POPULAR TOURS</h1>
      </div>
      <div className="w-full flex-4 h-full ">
        ...
        <div className="w-full flex justify-center items-center ">
          {[0, 2, 4].map((e,i) => {
            return (
              <div key={i} className="w-full max-w-sm bg-neutral-50 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-hidden m-3">
              <a href="#">
                <img
